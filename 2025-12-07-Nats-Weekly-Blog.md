...
## Project Summary:
This capstone project explores how anthropologists can bring the physical world into the digital realm through emerging 3D scanning technologies. By attempting to digitally 3D scan artifacts, the project engages directly with anthropological questions about preservation, accessibility, and the translation of material culture into new mediums, such as SketchFab. The challenges encountered throughout this project highlight not only the technical limitations of current tools but also the broader disciplinary wide conversations about data access, representation, and the responsibilities researchers hold when reproducing cultural materials in virtual spaces. In this way, the project became a digital experiment and an anthropological representation of how accessability and the digital realm shape the way we record, share, and interact with the past.
...
## Strenghts and Weaknesses as an Anthropologist 
I did not see anything about this in the project description, but it is in the syllabus so I am going to include it.

Working through this project, and taking this course, has allowed me to reflect deeply on both me weaknesses and strengths as an anthropologist. One of the most significant weaknesses I have realized is impatience, especially when working with curation, digitization, and the slow methodical steps required to responsibly document and preserve information. This project has taught me that digital anthropology requires a lot of things, some being, checking software compatibility, organizing files, recording metadata, scanning (repeatedly), and trouble shooting anything that pops up. I tend to want results quickly, especially when I am excited about a project or I have a specific vision for the end result in mind. This became very clear throughout the 3D scanning process. Each malfunctioning app, incomplete model, failed export, or outdated piece of hardware really showed me my lack of patience. I often found myself frustrated with how long the process to even start took, especially when these limitations were beyond my control. Recognizing this impatience has been an important step in my process, and reminds me that anthropological knowledge, like all knowledge, should not be rushed; it is built deliberatly over time.
At the same time, this project reaffirmed one of my strengths: my commitment to producing high-quality work. I care deeply about doing things well, and I am willing to put in significant effort to reach that standard. Even when the project pushed the limits of my perseverance, I continued experimenting, researching, asking questions, trying new software and apps, and seeking alternative solutions. I tested multiple scanning apps, learned unfamiliar platforms and software, worked with campus resources to gain access to the software, and adapted repeatedly. Although none of the attempts generated the high quality 3D scans I had hoped for, I never lost interest in the project. 
Beyone the project, this course has fundamentally changed and expanded how I think and work as an anthropologist. We did not just learn digital tools in this course, we look at broader ethical and theoretical frameworks that allowed us to examine why we do things the way we do. Digitization of materials is not just preservation it is equity, equal access for all is a vital part of sustainable academia and a continuation of making the world accessible to all equally. Additionally, our emphasis on data managment plans was really benefical for me especially the DMP software. As a result, I am leaving this course with significantly imporved digital skills and I understand why those skills matter. 


## Reflection on Project Purpose and Process:

I chose this project because I wanted to challenge myself to learn new digital and anthropological skills, such as photogrammetry, 3D scanning, and SketchFab. However, I found that I learned most about what goes into digital curation and accessability. Throughout the semester, we discussed the importance of accessability, open access knowledge, and the role of digital tools in public archaeology and anthropology. This project ended up being just that. A way to develop and contribute something meaningful, but small, a digital museum display PowerPoint and 3D scans of 8 artifacts. This could, in theory, help make cultural heritage from Miller Grove more visible and accessible. In doing this project I also wanted to push myself to use new things such as SketchFab, 3D scanning apps, and possibly Blender, all of which have been used increasingly more in the field of anthropology. The process of creating this capstone project was far more complex than I initally expected. It was difficult, often frustrating, and required constant problem solving and pivoting when tools failed or produced low quality results. There were moments (a lot in fact) when I did not enjoy the work simply because the outcomes never matched my standards or vision, but looking back, I appreciate how much I learned through those difficulties. It was not an easy project by any means, yet the challenges pushed me to think critically about what access really means in digital curation. In that way, the project deeply connected with course themes of accessability and open access, although I did not expect it to do that. I feel like I gained a lot of valuable insight into the realities of digital curation, public accessibility, and the labor involved in producing open access museum materials. I learned firsthand how cost barriers, outdated technology, and software limitations restrict what can be created and shared with the public. Despite these difficulties, I am proud of the adaptability, problem solving, and persistence I demonstrated. The final product reflects my best effort within the constraints I encountered. I also believe that the documentation of this process, on GitHub, may serve as a helpful guide for future students attempting similar work. By outlining what did and did not work, others may be able to build upon my experience and find solutions that were not available to me.
